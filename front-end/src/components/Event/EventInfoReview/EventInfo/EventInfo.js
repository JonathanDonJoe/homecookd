...
export class EventInfo extends Component {
    render() {
        ...
        return (
            <div className='event-info blue-grey lighten-3 col s12 m3'>
                <h5>Information</h5>
                <h6>Hosted By:</h6>
                <h6>{this.props.event.event.users_name}</h6>
                <img id="host-image-style" className='host-image' src={this.props.event.event.users_picture} alt='user_avatar' />
